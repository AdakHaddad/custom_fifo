...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/KRIA_CUSTOM_AXIS_IP_RM/KRIA_CUSTOM_AXIS_IP_RM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CUSTOM_AXIS_IP_RM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CUSTOM_AXIS_IP_RM_wrapper.tcl -notrace
