...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/KRIA_CUSTOM_AXIS_IP_RM/KRIA_CUSTOM_AXIS_IP_RM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CUSTOM_AXIS_IP_RM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CUSTOM_AXIS_IP_RM_wrapper.tcl
