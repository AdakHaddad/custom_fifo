...
################################################################
# This is a generated script based on design: CUSTOM_AXIS_IP_RM
#
...
# source CUSTOM_AXIS_IP_RM_script.tcl
...
set design_name CUSTOM_AXIS_IP_RM
...
xilinx.com:user:AXIS_FIFO_CUSTOM_RM:1.0\
"
...
\
  ...
  # Create instance: AXIS_FIFO_CUSTOM_RM_0, and set properties
  set AXIS_FIFO_CUSTOM_RM_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXIS_FIFO_CUSTOM_RM:1.0 AXIS_FIFO_CUSTOM_RM_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net AXIS_FIFO_CUSTOM_RM_0_M00_AXIS [get_bd_intf_pins AXIS_FIFO_CUSTOM_RM_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AXIS_FIFO_CUSTOM_RM_0/S00_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins AXIS_FIFO_CUSTOM_RM_0/s00_axis_aresetn] [get_bd_pins AXIS_FIFO_CUSTOM_RM_0/m00_axis_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins AXIS_FIFO_CUSTOM_RM_0/s00_axis_aclk] [get_bd_pins AXIS_FIFO_CUSTOM_RM_0/m00_axis_aclk]
